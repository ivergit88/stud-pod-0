    ...
    <div className="org-dashboard-page mx-auto max-w-7xl space-y-8 py-6 sm:py-8">
      ...
      {user.status === 'moderation' && (
        <div className="a11y-org-warning rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-base font-medium leading-7 text-amber-900">
          Заявка организации на модерации. Публикация задач и мероприятий откроется после
          подтверждения администратором — напишите нам, и мы подтвердим заявку. Просмотр кабинета
          и черновики доступны уже сейчас.
        </div>
      )}

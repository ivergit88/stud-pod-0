...
export const RegisterChoice: React.FC = () => {
  return (
    <div className="register-choice-page max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <div className="a11y-force-accent mb-5 inline-flex rounded-2xl bg-blue-50 p-4 text-blue-700">
        ...
        <Link
          ...
          className="a11y-register-card a11y-force-surface group rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-blue-300 hover:shadow-md sm:p-8"
        >
          <div className="a11y-force-accent mb-5 inline-flex rounded-2xl bg-orange-50 p-4 text-orange-700">
